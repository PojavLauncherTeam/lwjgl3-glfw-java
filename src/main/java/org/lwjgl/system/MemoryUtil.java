...
public final class MemoryUtil {
    ...
    public static ShortBuffer memAllocShort(int size) {
        return memShortBuffer(nmemAllocChecked(size << 1), size);
    }
    ...
    public static IntBuffer memAllocInt(int size) {
        return memIntBuffer(nmemAllocChecked(size << 2), size);
    }
    ...
    public static FloatBuffer memAllocFloat(int size) {
        return memFloatBuffer(nmemAllocChecked(size << 2), size);
    }
    ...
    public static LongBuffer memAllocLong(int size) {
        return memLongBuffer(nmemAllocChecked(size << 3), size);
    }
    ...
    public static DoubleBuffer memAllocDouble(int size) {
        return memDoubleBuffer(nmemAllocChecked(size << 3), size);
    }
    ...
    public static PointerBuffer memAllocPointer(int size) {
        return memPointerBuffer(nmemAllocChecked(size << POINTER_SHIFT), size);
    }
    ...
    public static ShortBuffer memCallocShort(int num) {
        return memShortBuffer(nmemCallocChecked(num, 2), num);
    }
    ...
    public static IntBuffer memCallocInt(int num) {
        return memIntBuffer(nmemCallocChecked(num, 4), num);
    }
    ...
    public static FloatBuffer memCallocFloat(int num) {
        return memFloatBuffer(nmemCallocChecked(num, 4), num);
    }
    ...
    public static LongBuffer memCallocLong(int num) {
        return memLongBuffer(nmemCallocChecked(num, 8), num);
    }
    ...
    public static DoubleBuffer memCallocDouble(int num) {
        return memDoubleBuffer(nmemCallocChecked(num, 8), num);
    }
    ...
    public static PointerBuffer memCallocPointer(int num) {
        return memPointerBuffer(nmemCallocChecked(num, POINTER_SIZE), num);
    }
    ...
    public static ShortBuffer memRealloc(ShortBuffer ptr, int size) {
        return realloc(ptr, memShortBuffer(nmemReallocChecked(memAddress0Safe(ptr), size << 1), size), size);
    }
    ...
    public static IntBuffer memRealloc(IntBuffer ptr, int size) {
        return realloc(ptr, memIntBuffer(nmemReallocChecked(memAddress0Safe(ptr), size << 2), size), size);
    }
    ...
    public static LongBuffer memRealloc(LongBuffer ptr, int size) {
        return realloc(ptr, memLongBuffer(nmemReallocChecked(memAddress0Safe(ptr), size << 3), size), size);
    }
    ...
    public static FloatBuffer memRealloc(FloatBuffer ptr, int size) {
        return realloc(ptr, memFloatBuffer(nmemReallocChecked(memAddress0Safe(ptr), size << 2), size), size);
    }
    ...
    public static DoubleBuffer memRealloc(DoubleBuffer ptr, int size) {
        return realloc(ptr, memDoubleBuffer(nmemReallocChecked(memAddress0Safe(ptr), size << 3), size), size);
    }
    ...
    public static PointerBuffer memRealloc(PointerBuffer ptr, int size) {
        PointerBuffer buffer = memPointerBuffer(nmemReallocChecked(memAddress0Safe(ptr), size << POINTER_SHIFT), size);
    ...
    public static String memUTF8(long address, int length) {
        ...
        ByteBuffer buffer = memByteBufferNT1(address);
        return memUTF8(buffer, length, 0);
    }
